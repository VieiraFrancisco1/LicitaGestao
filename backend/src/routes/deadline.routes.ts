...
import {
  deadlineTenderSchema,
  dismissDeadlineSchema,
  listDeadlineSchema,
  readDeadlineSchema
} from '../validators/deadline.validator.js';
...
deadlineRouter.post('/dismiss', validate(dismissDeadlineSchema), asyncHandler(controller.dismiss));
