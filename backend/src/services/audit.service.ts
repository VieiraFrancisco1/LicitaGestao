...
export const AuditActions = {
  CREATE: 'CREATE', UPDATE: 'UPDATE', DELETE: 'DELETE', STATUS_CHANGE: 'STATUS_CHANGE', UPLOAD: 'UPLOAD'
} as const;
...
export async function listAuditLogs(
  query: { page: number; pageSize: number; action?: AuditAction; entityType?: string; search?: string },
  auth: AuthScope
) {
